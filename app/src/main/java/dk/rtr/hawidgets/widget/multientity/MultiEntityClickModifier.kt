...
import dk.rtr.hawidgets.widget.common.ConfirmActionActivity
import dk.rtr.hawidgets.widget.common.DateTimeControlActivity
import dk.rtr.hawidgets.widget.common.NumberInputActivity
import dk.rtr.hawidgets.widget.common.RangeControlActivity
import dk.rtr.hawidgets.widget.common.TextControlActivity
import dk.rtr.hawidgets.widget.common.RefreshEntityAction
import dk.rtr.hawidgets.widget.common.ToggleEntityAction
import dk.rtr.hawidgets.widget.common.TriggerEntityAction
import dk.rtr.hawidgets.widget.common.friendlyNameFromJson
import dk.rtr.hawidgets.widget.common.isActiveState
import dk.rtr.hawidgets.widget.common.rangeCurrentValue
import dk.rtr.hawidgets.widget.common.rangeMax
import dk.rtr.hawidgets.widget.common.rangeMin
...
internal fun clickModifier(
    ...
    if (action == "OPEN_APP") {
        ...
        val intent = Intent(context, dk.rtr.hawidgets.widget.common.AppLaunchActivity::class.java).apply {
            putExtra(dk.rtr.hawidgets.widget.common.AppLaunchActivity.EXTRA_PACKAGE, pkg)
