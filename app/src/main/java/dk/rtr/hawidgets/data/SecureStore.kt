...
class SecureStore private constructor(private val prefs: SharedPreferences) {
    ...
    /**
     * Global baggrunds-pull-frekvens i minutter for ALLE widgets ([dk.rtr.hawidgets.worker.SyncWorker]).
    ...
    /** Sat af [dk.rtr.hawidgets.logging.RemoteLogger.installCrashHandler] hvis forrige proces
     ...
     * KUN fra [dk.rtr.hawidgets.logging.RemoteLogger.installCrashHandler]. `.apply()` skriver
     ...
     * eller farvetema-nøglen ændres. Collectes af [dk.rtr.hawidgets.widget.common.WidgetGlanceTheme]
