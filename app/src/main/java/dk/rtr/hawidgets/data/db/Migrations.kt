...
/** v15→v16: pr.-widget række-densitet ("COMPACT"/"NORMAL"/"LARGE"). Additiv, ikke-destruktiv —
 * eksisterende widgets får DEFAULT 'NORMAL' (= uændret 60dp-række). */
val MIGRATION_15_16 = object : Migration(15, 16) {
    override fun migrate(db: SupportSQLiteDatabase) {
        db.execSQL("ALTER TABLE `multi_widget` ADD COLUMN `rowDensity` TEXT NOT NULL DEFAULT 'NORMAL'")
    }
}
