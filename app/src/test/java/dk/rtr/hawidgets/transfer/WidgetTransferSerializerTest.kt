...
class WidgetTransferSerializerTest {
    ...
    private fun bundle() = TransferBundle(
        ...
        configs = listOf(
            TransferConfig.Multi(label = "Multi: Stue", showRefreshIcon = false, rowDensity = "COMPACT", slots = listOf(slotWithChips(0), slotWithChips(1))),
    ...
    @Test fun roundTripPreservesMultiAndShortcut() {
        ...
        assertEquals("COMPACT", multi.rowDensity)
